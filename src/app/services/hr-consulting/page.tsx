...
const HRConsultingModel = dynamic(() => import('../../components/ServiceModels').then(m => ({ default: m.HRConsultingModel })), { ssr: false });
...
const services = [
  { Icon: Users, title: "Talent Management", desc: "Strategic workforce planning and talent acquisition solutions tailored to your growth trajectory." },
  { Icon: BookOpen, title: "Organizational Development", desc: "Structured approaches to improve organizational effectiveness and workplace culture." },
  { Icon: Heart, title: "Employee Engagement", desc: "Programs to boost workplace satisfaction, retention, and overall employee experience." },
  { Icon: Shield, title: "Policy & Compliance", desc: "Expert guidance on HR regulations, labor laws, and industry best practices." },
  { Icon: BarChart, title: "Performance Management", desc: "Systems to track, evaluate, and continually improve employee performance metrics." },
  { Icon: Award, title: "Training & Development", desc: "Customized learning programs designed for professional growth and skill advancement." },
];
    ...
    <div className="bg-[#030712] min-h-screen">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: false }} variants={stagger}>
              ...
              <motion.h1 variants={fadeUp} custom={1} className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white tracking-tight leading-[1.1] mb-6">
                HR <span className="text-gold-gradient">Consulting</span>
              </motion.h1>
              <motion.p variants={fadeUp} custom={2} className="text-white/50 text-lg max-w-lg font-light leading-relaxed mb-8">
                Transform your human resources strategy with our comprehensive consulting solutions that empower your workforce.
              </motion.p>
              <motion.div variants={fadeUp} custom={3} className="flex flex-wrap gap-4">
                {['Talent Strategy', 'Workforce Planning', 'Culture Building'].map(tag => (
      ...
      <section className="py-20 md:py-28 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: false }} variants={stagger}>
            <motion.h2 variants={fadeUp} custom={0} className="text-4xl md:text-5xl font-bold text-white tracking-tight mb-6">
            ...
            <motion.div variants={fadeUp} custom={1} className="rounded-2xl border border-white/[0.08] bg-white/[0.02] backdrop-blur-xl p-8 md:p-12">
              <p className="text-white/55 text-lg leading-relaxed font-light">
                ...
                and workplace culture transformation across diverse industries. We partner with organizations
                to build resilient, high-performing teams that drive sustainable business growth.
              </p>
            </motion.div>
          </motion.div>
        </div>
